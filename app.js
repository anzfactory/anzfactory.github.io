...
module.exports = riot.tag2('anz-app', '<anz-app-header></anz-app-header> <anz-app-menu></anz-app-menu> <section class="section"> <div class="container"> <app></app> </div> </section> <footer class="footer"> </footer>', '', '', function(opts) {
'use strict';
});
