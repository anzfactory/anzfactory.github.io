...
var riot = require('riot');
module.exports = riot.tag2('anz-app-header', '<section class="hero is-main-color is-bold"> <div class="hero-head"> <div class="container"> <nav class="nav"> <div class="nav-left"> <a class="nav-item is-brand text light-color" href="#">anz factory</a> </div> <div class="nav-center"> <a class="nav-item" href="https://twitter.com/AnzNetJp"> <span class="icon text light-color"> <i class="fa fa-twitter"></i> </span> </a> </div> <div class="nav-right"> <a class="nav-item" href="http://t.umblr.com/redirect?z=https%3A%2F%2Fdocs.google.com%2Fforms%2Fd%2Fe%2F1FAIpQLSfj9xxAh9ReqXr1NdDjKLlxroYxKL1vBDT6ApDPwIrzOOD3lg%2Fviewform&t=ZGI0MDc1OTAwY2YxM2JhZDZiNjg4MGQzYTcwN2Q3ZmI3YjQ5ZDk2NixUbU4zdWpESg%3D%3D&m=0"> <span class="icon text light-color"> <i class="fa fa-question-circle" aria-hidden="true"></i> </span> </a> </div> </nav> </div> </div> <div class="hero-body"> <div class="columns"> <div class="column is-one-quarter is-offset-one-quarter store-item"> <a class="button is-large store-icon {\'is-disabled\':!apple}" href="{apple}"> <span class="icon is-medium"> <i class="fa fa-apple"></i> </span> <span>App Store</span> </a> </div> <div class="column is-one-quarter store-item"> <a class="button is-large store-icon {\'is-disabled\':!google}" href="{google}"> <span class="icon is-medium"> <i class="fa fa-android"></i> </span> <span>Google Play</span> </a> </div> </div> </div> <div class="hero-foot"> <div class="container"> <nav class="tabs is-boxed"> <ul> <li each="{games}" class="{\'is-active\': isActive(name)}"> <a class="text light-color" href="#{gameTop(name)}">{gameName(name)}</a> </li> </ul> </nav> </div> </div> </section>', 'anz-app-header .store-item:first-child,[riot-tag="anz-app-header"] .store-item:first-child,[data-is="anz-app-header"] .store-item:first-child{ text-align: right; } anz-app-header .store-icon,[riot-tag="anz-app-header"] .store-icon,[data-is="anz-app-header"] .store-icon{ background: #000; color: #fff; } anz-app-header .button.is-disabled,[riot-tag="anz-app-header"] .button.is-disabled,[data-is="anz-app-header"] .button.is-disabled{ background-color: #333; opacity: 0.5; } @media screen and (max-width: 768px) { anz-app-header .store-item,[riot-tag="anz-app-header"] .store-item,[data-is="anz-app-header"] .store-item{ text-align: center !important; } }', '', function(opts) {
'use strict';
...
this.on('mount', function () {
  ...
  Blazy.load(document.querySelectorAll('.catbox-thumb'), true);
});
});
...
var riot = require('riot');
module.exports = 
riot.tag2('anz-catbox-screenshot', '<div class="columns is-multiline"> <div each="{screenshots}" class="column is-3"> <div class="card" onclick="{onClickCard}"> <div class="card-image"> <figure class="image is-4by3 screenshot-img" data-src="{src}"> </figure> </div> <div class="card-content"> <div class="content"> <raw html="{description}"></raw> </div> </div> </div> </div> </div> <anz-modal-image></anz-modal-image>', 'anz-catbox-screenshot .screenshot-img,[riot-tag="anz-catbox-screenshot"] .screenshot-img,[data-is="anz-catbox-screenshot"] .screenshot-img{ background-repeat: no-repeat; background-position: center; background-size: cover; }', '', function(opts) {
'use strict';
...
this.on('mount', function () {
  ...
  Blazy.load(document.querySelectorAll('.screenshot-img'), true);
});
});
